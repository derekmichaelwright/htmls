...
The correlation coefficient (*R^2^*), which indicates the proportion of variation explained by an independant variable or model, can be calculated in more than one way. The goal of this vignette is to help clear up this confusion, with a few different examples.
...
# Preview data
knitr::kable(d1[c(1:3,31:33,49:51),])
```

[*Table 1: Correlation data set #1 (d1).*](https://github.com/derekmichaelwright/myblog/tree/master/content/dblogr_posts/correlation_coefficients/Data_1.csv)
...
```{r echo = F}
ggsave("../../academic_graphs/correlation_coefficients/gallery/gallery/corr_coef_01.png", mp, width = 10, height = 4)
```
...
```{r echo = F}
ggsave("../../academic_graphs/correlation_coefficients/gallery/gallery/corr_coef_02.png", mp, width = 8, height = 4)
...
```{r echo = F}
ggsave("../../academic_graphs/correlation_coefficients/gallery/gallery/corr_coef_03.png", mp, width = 8, height = 4)
```
...
```{r echo = F}
ggsave("../../academic_graphs/correlation_coefficients/gallery/gallery/corr_coef_04.png", mp, width = 8, height = 4)
```
...
# Preview data
knitr::kable(d2[c(1:3,478:480,970:972),])
```

[*Table 2: Correlation data set #2 (d2).*](https://github.com/derekmichaelwright/myblog/tree/master/content/dblogr_posts/correlation_coefficients/Data_2.csv)
...
```{r echo = F}
ggsave("../../academic_graphs/correlation_coefficients/gallery/gallery/corr_coef_05.png", mp, width = 8, height = 4)
```
...
```{r echo = F}
ggsave("../../academic_graphs/correlation_coefficients/gallery/gallery/corr_coef_06.png", mp, width = 8, height = 10)
```
...
```{r echo = F}
ggsave("../../academic_graphs/correlation_coefficients/gallery/gallery/corr_coef_07.png", mp, width = 8, height = 4)
```
...
```{r}
ggsave("../../academic_graphs/correlation_coefficients/gallery/gallery/corr_coef_08.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../academic_graphs/correlation_coefficients/gallery/gallery/corr_coef_09.png", mp, width = 10, height = 4)
```
...
```{r echo = F}
ggsave("../../academic_graphs/correlation_coefficients/gallery/gallery/corr_coef_10.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../academic_graphs/correlation_coefficients/gallery/gallery/corr_coef_11.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../academic_graphs/correlation_coefficients/gallery/gallery/corr_coef_12.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../academic_graphs/correlation_coefficients/gallery/gallery/corr_coef_13.png", mp, width = 8, height = 4)
```
...
file.copy(from = "corr_coef_14.png", overwrite = T,
          to = "../../academic_graphs/correlation_coefficients/gallery/gallery/")
```
