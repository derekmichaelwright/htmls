...
author: "Derek Michael Wright <wrightmderek@gmail.com> [www.dblogr.com/](https://dblogr.netlify.com/) [-Image Gallery-](https://dblogr.netlify.app/graphs_agdata/cotton/)"
date: "2020-03-01"
categories: [ "agData" ]
tags: [ "agData", "Cotton" ]
image:
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/cotton/gallery/gallery/cotton_01.png", mp, width = 6, height = 4)
ggsave("../../../myblog/content/posts_agdata/cotton/featured.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/cotton/gallery/gallery/cotton_02.png", mp, width = 6, height = 4)
```
