...
date: "2020-10-01"
author: "Derek Michael Wright <wrightmderek@gmail.com> [www.dblogr.com/](https://dblogr.com/) [-Image Gallery-](https://dblogr.com/graphs_agdata/crops_canada/)"
---
...
mp <- ggplot(xx, aes(x = Crop, y = Value / 1000000, fill = Crop)) + 
  ...
  scale_fill_manual(values = alpha(agData_Colors, 0.75)) +
  theme_agData(legend.position = "none", rotx = T) + 
  labs(title = "Canada - Area Seeded - {round(frame_time)}", 
...
```{r echo = F}
anim_save("../../../myblog/content/graphs_agdata/crops_canada/gallery/gallery/crops_canada_gifs_01.gif", mp, width = 600, height = 500)
```
