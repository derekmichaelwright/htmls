...
```{r echo = F}
ggsave("../../agdata_graphs/crops_canada/gallery/gallery/crops_canada_01.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_canada/gallery/gallery/crops_canada_02.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_canada/gallery/gallery/crops_canada_03.png", mp, width = 6, height = 5)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_canada/gallery/gallery/crops_canada_04.png", mp, width = 6, height = 5)
