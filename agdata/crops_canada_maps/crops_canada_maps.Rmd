...
```{r echo = F}
ggsave("../../agdata_graphs/crops_canada_maps/gallery/gallery/maps_crops_canada_01.png", width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_canada_maps/gallery/gallery/maps_crops_canada_02.png", mp, width = 6, height = 4)
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_canada_maps/gallery/gallery/maps_crops_canada_03.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_canada_maps/gallery/gallery/maps_crops_canada_04.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_canada_maps/gallery/gallery/maps_crops_canada_05.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_canada_maps/gallery/gallery/maps_crops_canada_06.png", width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_canada_maps/gallery/gallery/maps_crops_canada_07.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_canada_maps/gallery/gallery/maps_crops_canada_08.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_canada_maps/gallery/gallery/maps_crops_canada_09.png", mp, width = 6, height = 4)
```
