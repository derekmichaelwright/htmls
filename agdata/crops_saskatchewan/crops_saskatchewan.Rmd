...
date: "2020-10-01"
author: "Derek Michael Wright <wrightmderek@gmail.com> [www.dblogr.com/](https://dblogr.com/) [-Image Gallery-](https://dblogr.com/graphs_agdata/crops_saskatchewan/)"
---
...
mp <- ggplot(xx, aes(x = Crop, y = Value / 1000000, fill = Crop)) + 
  ...
  scale_fill_manual(values = alpha(agData_Colors, 0.75)) +
  theme_agData(legend.position = "none", rotx = T) + 
  labs(title = "Saskatchewan - Crop Production - {round(frame_time)}", 
       y = "Million Tonnes", x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: STATCAN") +
  # gganimate specific bits
  transition_time(Year) +
  ease_aes('linear')
anim_save("crops_saskatchewan_gifs_01.png", mp, width = 600, height = 400)
```

```{r echo = F}
anim_save("../../../myblog/content/graphs_agdata/crops_saskatchewan/gallery/gallery/crops_saskatchewan_gifs_01.png", mp, width = 600, height = 400)
```

![](crops_saskatchewan_gifs_01.png)
...
mp <- ggplot(xx, aes(x = Crop, y = Value / 1000000, fill = Crop)) + 
  ...
  scale_fill_manual(values = alpha(agData_Colors, 0.75)) +
  theme_agData(legend.position = "none", rotx = T) + 
  labs(title = "Saskatchewan - Area Seeded - {round(frame_time)}", 
       y = "Million Hectares", x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: STATCAN") +
  # gganimate specific bits
  transition_time(Year) +
  ease_aes('linear')
anim_save("crops_saskatchewan_gifs_02.png", mp, width = 600, height = 400)
```

```{r echo = F}
anim_save("../../../myblog/content/graphs_agdata/crops_saskatchewan/gallery/gallery/crops_saskatchewan_gifs_02.png", mp, width = 600, height = 400)
```
