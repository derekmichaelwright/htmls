...
links: 
  - icon_pack: fas
    icon: chart-line
    name: All Graphs
    url: agdata_graphs/crops_saskatchewan
  - icon_pack: far
    icon: file-code
    name: HTML
  ...
  - icon_pack: far
    icon: file-pdf
    name: Save/Print
    url: agdata_pdfs/crops_saskatchewan.pdf
---
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_saskatchewan/gallery/gallery/crops_saskatchewan_01.png", mp, width = 6, height = 5)
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_saskatchewan/gallery/gallery/crops_saskatchewan_02.png", mp, width = 6, height = 5)
ggsave("../../home/gallery/gallery/02_crops_saskatchewan_02.png", mp, width = 6, height = 5)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_saskatchewan/gallery/gallery/crops_saskatchewan_03.png", mp, width = 6, height = 5)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_saskatchewan/gallery/gallery/crops_saskatchewan_04.png", mp, width = 6, height = 4)
```
