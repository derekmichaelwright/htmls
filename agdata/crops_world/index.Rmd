...
```{r echo = F}
ggsave("../../agdata_graphs/crops_world/gallery/gallery/crops_world_01.png", mp, width = 6, height = 4)
ggsave("../../home/gallery/gallery/01_crops_world_01.png", mp, width = 6, height = 4)
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_world/gallery/gallery/crops_world_02.png", width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_world/gallery/gallery/crops_world_03.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/crops_world/gallery/gallery/crops_world_04.png", mp, width = 6, height = 4)
```
