...
links: 
  ...
  - icon_pack: far
    icon: file-pdf
    name: Save/Print
    url: agdata_pdfs/fertilizers.pdf
---
...
```{r echo = F}
ggsave("../../agdata_graphs/fertilizers/gallery/gallery/fertilizers_01.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/fertilizers/gallery/gallery/fertilizers_02.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/fertilizers/gallery/gallery/fertilizers_03.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/fertilizers/gallery/gallery/fertilizers_04.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/fertilizers/gallery/gallery/fertilizers_05.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/fertilizers/gallery/gallery/fertilizers_06.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/fertilizers/gallery/gallery/fertilizers_07.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/fertilizers/gallery/gallery/fertilizers_08.png", mp, width = 6, height = 4)
```
...
ggsave("../../agdata_graphs/fertilizers/gallery/gallery/fertilizers_09.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/fertilizers/gallery/gallery/fertilizers_10.png", mp, width = 6, height = 4)
```
