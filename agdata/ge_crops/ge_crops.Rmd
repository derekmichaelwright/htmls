...
date: "2020-03-01"
author: "Derek Michael Wright <wrightmderek@gmail.com> [www.dblogr.com/](https://dblogr.netlify.com/) [-Image Gallery-](https://dblogr.netlify.app/graphs_agdata/ge_crops/)"
---
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/ge_crops/gallery/gallery/ge_crops_01.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/ge_crops/gallery/gallery/ge_crops_02.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/ge_crops/gallery/gallery/ge_crops_03.png", mp, width = 6, height = 4)
ggsave("../../../myblog/content/posts_agdata/ge_crops/featured.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/ge_crops/gallery/gallery/ge_crops_04.png", mp, width = 6, height = 4)
```
...
```{r echo = F,}
ggsave("../../../myblog/content/graphs_agdata/ge_crops/gallery/gallery/ge_crops_05.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/ge_crops/gallery/gallery/ge_crops_06.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/ge_crops/gallery/gallery/ge_crops_07.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/ge_crops/gallery/gallery/ge_crops_08.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/ge_crops/gallery/gallery/ge_crops_09.png", mp, width = 6, height = 4)
ggsave("../../../myblog/content/home/gallery/gallery/06_ge_crops_09.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/ge_crops/gallery/gallery/ge_crops_10.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/ge_crops/gallery/gallery/ge_crops_11.png", mp, width = 6, height = 4)
ggsave("../../../myblog/content/home/gallery/gallery/06_ge_crops_11.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/ge_crops/gallery/gallery/ge_crops_12.png", mp, width = 15, height = 15)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/ge_crops/gallery/gallery/ge_crops_13.png", mp, width = 6, height = 4)
```
...
```{r eval = F, echo = F}
ggsave("../../../myblog/content/graphs_agdata/ge_crops/gallery/gallery/ge_crops_14.png", mp, width = 6, height = 4)
```
