...
links:
  - icon_pack: fas
    icon: chart-line
    name: All Graphs
    url: agdata_graphs/honeybee_canada
  - icon_pack: far
    icon: file-code
    name: HTML
  ...
  - icon_pack: far
    icon: file-pdf
    name: PDF (Save/Print)
    url: agdata_pdfs/honeybee_canada.pdf
---
...
```{r echo = F}
ggsave("../../agdata_graphs/honeybee_canada/gallery/gallery/honeybee_canada_01.png", mp, width = 6, height = 8)
ggsave("../../home/gallery/gallery/07_honeybee_canada_01.png", mp, width = 6, height = 8)
...
```{r echo = F}
ggsave("../../agdata_graphs/honeybee_canada/gallery/gallery/honeybee_canada_02.png", mp, width = 6, height = 4)
```
