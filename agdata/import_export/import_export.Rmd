...
date: "2020-03-01"
author: "Derek Michael Wright <wrightmderek@gmail.com> [www.dblogr.com/](https://dblogr.netlify.com/) [-Image Gallery-](https://dblogr.netlify.app/graphs_agdata/global_food_security/)"
---
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/global_food_security/gallery/gallery/import_export_01.png", mp, width = 6, height = 3.75)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/global_food_security/gallery/gallery/import_export_02.png", mp, width = 6, height = 3.75)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/global_food_security/gallery/gallery/import_export_03.png", mp, width = 6, height = 3.75)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/global_food_security/gallery/gallery/import_export_04.png", mp, width = 6, height = 3.75)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/global_food_security/gallery/gallery/import_export_05.png", mp, width = 6, height = 3.75)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/global_food_security/gallery/gallery/import_export_06.png", mp, width = 6, height = 3.75)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/global_food_security/gallery/gallery/import_export_07.png", mp, width = 6, height = 3.75)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/global_food_security/gallery/gallery/import_export_08.png", mp, width = 6, height = 3.75)
ggsave("../../../myblog/content/posts_agdata/global_food_security/featured.png", mp, width = 6, height = 3.75)
```
