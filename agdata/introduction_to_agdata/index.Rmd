...
links:
  - icon_pack: fas
    icon: chart-line
    name: All Graphs
    url: agdata_graphs/introduction_to_agdata
  - icon: file-code
    icon_pack: far
    name: HTML
  ...
  - icon_pack: far
    icon: file-pdf
    name: PDF (Save/Print)
    url: agdata_pdfs/introduction_to_agdata.pdf
---
...
This will also the load the following packages: `tidyverse`, `ggarrange`, `ggpubr` & `ggrepel`.
...
```{r}
xx <- data.frame(x = 1:10, y = 1:10, color = rep(c("1","2"), times = 2, each = 5))
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_01.png", mp, width = 6, height = 4)
```
...
```{r}
# Prep data for an example plot
xx <- xx %>% filter(Area == "World", Item == "Agricultural area")
# Plot
mp <- ggplot(xx, aes(x = Year, y = Value / 1000000, group = Area)) + 
  geom_line() + 
  theme_agData() +
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_02.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_03.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_04.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_05.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_06.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_07.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_08.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_09.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_10.png", mp,width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_11.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_13.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_14.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_15.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_16.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_17.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/introduction_to_agdata/gallery/gallery/introduction_to_agdata_18.png", mp, width = 6, height = 4)
```
