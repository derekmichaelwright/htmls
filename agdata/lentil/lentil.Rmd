...
```{r echo = F}
ggsave("../../agdata_graphs/lentil/gallery/gallery/lentil_01.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/lentil/gallery/gallery/lentil_02.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/lentil/gallery/gallery/lentil_03.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/lentil/gallery/gallery/lentil_04.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/lentil/gallery/gallery/lentil_05.png", mp, width = 6, height = 4)
ggsave("../../home/gallery/gallery/05_lentil_05.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/lentil/gallery/gallery/lentil_06.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/lentil/gallery/gallery/lentil_07.png", mp, width = 6, height = 4)
ggsave("../../home/gallery/gallery/05_lentil_07.png", mp, width = 6, height = 4)
...
```{r echo = F}
ggsave("../../agdata_graphs/lentil/gallery/gallery/lentil_08.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/lentil/gallery/gallery/lentil_09.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/lentil/gallery/gallery/lentil_10.png", mp, width = 6, height = 4)
```
