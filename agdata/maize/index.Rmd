...
```{r echo = F}
ggsave("../../agdata_graphs/maize/gallery/gallery/maize_01.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/maize/gallery/gallery/maize_02.png", mp, width = 6, height = 4)
...
```{r echo = F}
ggsave("../../agdata_graphs/maize/gallery/gallery/maize_03.png", mp, width = 6, height = 4)
ggsave("featured.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/maize/gallery/gallery/maize_04.png", mp, width = 6, height = 4)
```
...
[**PDF**: Maize production by country.](Maize_FAO.pdf)
