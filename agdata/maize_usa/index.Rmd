...
```{r echo = F}
ggsave("../../agdata_graphs/maize_usa/gallery/gallery/maize_usa_01.png", mp, width = 6, height = 4)
ggsave("../../home/gallery/gallery/04_maize_usa_01.png", mp, width = 6, height = 4)
...
```{r echo = F}
ggsave("../../agdata_graphs/maize_usa/gallery/gallery/maize_usa_02.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/maize_usa/gallery/gallery/maize_usa_03.png", mp, width = 6, height = 4)
...
```{r echo = F}
ggsave("../../agdata_graphs/maize_usa/gallery/gallery/maize_usa_04.png", mp, width = 6, height = 4)
ggsave("../../home/gallery/gallery/04_maize_usa_04.png", mp, width = 6, height = 4)
...
```{r echo = F}
ggsave("../../agdata_graphs/maize_usa/gallery/gallery/maize_usa_05.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/maize_usa/gallery/gallery/maize_usa_06.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/maize_usa/gallery/gallery/maize_usa_07.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/maize_usa/gallery/gallery/maize_usa_08.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/maize_usa/gallery/gallery/maize_usa_09.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/maize_usa/gallery/gallery/maize_usa_10.png", mp, width = 6, height = 4)
```
