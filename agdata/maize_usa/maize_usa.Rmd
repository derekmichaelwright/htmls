...
date: "2020-10-01"
author: "Derek Michael Wright <wrightmderek@gmail.com> [www.dblogr.com/](https://dblogr.com/) [-Image Gallery-](https://dblogr.com/graphs_agdata/maize_usa/)"
---
...
mp1 <- mp +
  geom_smooth(aes(x = Year, y = Value, group = Era), method = "lm", se = F, colour = "Black") +
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/maize_usa/gallery/gallery/maize_usa_01.png", mp1, width = 6, height = 4)
ggsave("../../../myblog/content/home/gallery/gallery/04_maize_usa_01.png", mp1, width = 6, height = 4)
#ggsave("C:/gitfolder/personalblog/content/articles/A_Quick_History_of_Hybrid_Crops/maize_usa_01.png", width = 9, height = 5)
ggsave("../../../myblog/content/posts_agdata/maize_usa/featured.png", mp1, width = 8, height = 5)
```
...
```{r echo = F}
anim_save("../../../myblog/content/graphs_agdata/maize_usa/gallery/gallery/maize_usa_gifs_01.gif", mp, width = 600, height = 400)
```
