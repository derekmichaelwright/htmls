...
```{r echo = F}
ggsave("../../agdata_graphs/nue/gallery/gallery/nue_01.png", mp, width = 6, height = 4)
```
...
ggsave("../../agdata_graphs/nue/gallery/gallery/nue_02.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/nue/gallery/gallery/nue_03_australia.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/nue/gallery/gallery/nue_04_canada.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/nue/gallery/gallery/nue_05_china.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/nue/gallery/gallery/nue_06_germany.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/nue/gallery/gallery/nue_07_india.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/nue/gallery/gallery/nue_08_france.png", mp, width = 6, height = 4)
```
