...
links: 
  - icon_pack: fas
    icon: chart-line
    name: All Graphs
    url: agdata_graphs/people_in_ag
  - icon_pack: far
    icon: file-code
    name: HTML
  ...
  - icon_pack: far
    icon: file-pdf
    name: PDF (Save/Print)
    url: agdata_pdfs/people_in_ag.pdf
---
...
```{r echo = F}
ggsave("../../agdata_graphs/people_in_ag/gallery/gallery/People_in_Ag_01.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/people_in_ag/gallery/gallery/People_in_Ag_02.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/people_in_ag/gallery/gallery/People_in_Ag_03.png", mp, width = 12, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/people_in_ag/gallery/gallery/People_in_Ag_04.png", mp, width = 6, height = 4)
```
