...
```{r echo = F}
ggsave("../../agdata_graphs/potato/gallery/gallery/potato_01.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/potato/gallery/gallery/potato_02.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/potato/gallery/gallery/potato_03.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/potato/gallery/gallery/potato_04.png", mp, width = 6, height = 4)
