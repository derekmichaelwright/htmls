...
date: "2020-09-01"
author: "Derek Michael Wright <wrightmderek@gmail.com> [www.dblogr.com/](https://dblogr.netlify.com/) [-Image Gallery-](https://dblogr.netlify.app/graphs_agdata/wheat_mexico/)"
---
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/wheat_mexico/gallery/gallery/wheat_mexico_01.png", mp1, width = 6, height = 4)
#ggsave("C:/gitfolder/personalblog/content/articles/Norman_Borlaug/wheat_mexico_01.png", width = 6, height = 4)
ggsave("../../../myblog/content/posts_agdata/wheat_mexico/featured.png", mp1, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../../myblog/content/graphs_agdata/wheat_mexico/gallery/gallery/wheat_mexico_02.png", mp2, width = 6, height = 4)
