...
links:
  - icon_pack: fas
    icon: chart-line
    name: All Graphs
    url: agdata_graphs/wheat_yields
  - icon: file-code
    icon_pack: far
    name: HTML
  ...
  - icon_pack: far
    icon: file-pdf
    name: PDF (Save/Print)
    url: mydocs/pdfs/wheat_yields.pdf
---
...
```{r echo = F}
ggsave("../../agdata_graphs/wheat_yields/gallery/gallery/wheat_yields_01.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/wheat_yields/gallery/gallery/wheat_yields_02.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/wheat_yields/gallery/gallery/wheat_yields_03.png", mp, width = 6, height = 8)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/wheat_yields/gallery/gallery/wheat_yields_04.png", mp, width = 6, height = 7)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/wheat_yields/gallery/gallery/wheat_yields_05.png", mp, width = 6, height = 8)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/wheat_yields/gallery/gallery/wheat_yields_06.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../agdata_graphs/wheat_yields/gallery/gallery/wheat_yields_07.png", mp, width = 6, height = 4)
```
