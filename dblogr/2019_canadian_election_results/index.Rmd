...
links:
  - icon: chart-line
    icon_pack: fas
    name: All Graphs
    url: dblogr_graphs/2019_canadian_election_results
  - icon: file-code
    icon_pack: far
    name: HTML
    url: https://derekmichaelwright.github.io/htmls/dblogr/2019_canadian_election_results.html
  - icon: file-pdf
    icon_pack: far
    name: PDF (Save/Print)
    url: dblogr_pdfs/2019_canadian_election_results.pdf
---
...
d1 <- dblogr_Election_2019_Party
write.csv(d1, "election_results_party.csv", row.names = F)
```
...
[*Table 1: 2019 Federal Election Results Summary (d1).*](https://github.com/derekmichaelwright/myblog/tree/master/content/dblogr/2019_canadian_election_results/election_results_party.csv)
...
d2 <- dblogr_Election_2019_District %>%
  mutate(`Percent of Votes` = round(`Percent of Votes`),
         SubRegion = ifelse(Area %in% provs, "Western Canada", "Eastern Canada"),
         SubRegion = factor(SubRegion, levels=c("Western Canada","Eastern Canada"))) %>%
  select(SubRegion, everything())
write.csv(d2, "election_results_district.csv", row.names = F)
```
...
[*Table 2: 2019 Federal Election Results by District (d2).*](https://github.com/derekmichaelwright/myblog/tree/master/content/dblogr/2019_canadian_election_results/election_results_district.csv)
...
xx <- mapcan(boundaries = ridings, type = standard) %>%
  left_join(xx, by = c("riding_code"="District Number"))
# Plot
mp <- ggplot(xx, aes(x = long, y = lat, group = group, fill = Party_Short)) +
  geom_polygon(color = "white", size = 0.1) + 
  coord_fixed() + theme_mapcan() +
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/canada/gallery/election_2019_00_map.png", mp, width = 6, height = 4)
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/canada/gallery/election_2019_00_provinces.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/canada/gallery/election_2019_00_provinces_votes.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Party_Short, y = Votes / 1000000)) +
  ...
  theme_dblogr(rotx = T, legend.position = "none") +
  labs(title = "2019 Canadian Federal Election Results",
       y = "Million Votes", x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: Elections Canada")
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/canada/gallery/election_2019_00_west_east_votes.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/canada/gallery/election_2019_00_west_east_districts.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/canada/gallery/election_2019_01_ca.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/eastern_canada/gallery/election_2019_01_ce.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/western_canada/gallery/election_2019_01_cw.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/prairie_ag/gallery/election_2019_01_ag.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/british_columbia/gallery/election_2019_01_bc.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/alberta/gallery/election_2019_01_ab.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/saskatchewan/gallery/election_2019_01_sk.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/manitoba/gallery/election_2019_01_mb.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/ontario/gallery/election_2019_01_on.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/quebec/gallery/election_2019_01_qc.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/new_brunswick/gallery/election_2019_01_nb.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/nova_scotia/gallery/election_2019_01_ns.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/prince_edward_island/gallery/election_2019_01_pe.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/newfoundland_Labrador/gallery/election_2019_01_nl.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/yukon/gallery/election_2019_01_yt.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/northwest_territories/gallery/election_2019_01_nt.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/nunavut/gallery/election_2019_01_nu.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/canada/gallery/election_2019_02_ca.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/eastern_canada/gallery/election_2019_02_ce.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/western_canada/gallery/election_2019_02_cw.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/prairie_ag/gallery/election_2019_02_ag.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/british_columbia/gallery/election_2019_02_bc.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/alberta/gallery/election_2019_02_ab.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/saskatchewan/gallery/election_2019_02_sk.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/manitoba/gallery/election_2019_02_mb.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/ontario/gallery/election_2019_02_on.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/quebec/gallery/election_2019_02_qc.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/new_brunswick/gallery/election_2019_02_nb.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/nova_scotia/gallery/election_2019_02_Votes_ns.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/prince_edward_island/gallery/election_2019_02_pe.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/newfoundland_Labrador/gallery/election_2019_02_nl.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/yukon/gallery/election_2019_02_yt.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/northwest_territories/gallery/election_2019_02_nt.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/nunavut/gallery/election_2019_02_nu.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/canada/gallery/election_2019_03_ca.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/eastern_canada/gallery/election_2019_03_ce.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/western_canada/gallery/election_2019_03_cw.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/prairie_ag/gallery/election_2019_03_ag.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/british_columbia/gallery/election_2019_03_bc.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/alberta/gallery/election_2019_03_ab.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/saskatchewan/gallery/election_2019_03_sk.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/manitoba/gallery/election_2019_03_mb.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/ontario/gallery/election_2019_03_on.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/quebec/gallery/election_2019_03_qc.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/new_brunswick/gallery/election_2019_03_nb.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/nova_scotia/gallery/election_2019_03_ns.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/prince_edward_island/gallery/election_2019_03_pe.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/newfoundland_Labrador/gallery/election_2019_03_nl.png", mp, width = 6, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/prairie_ag/gallery/election_2019_04_ag.png", mp, width = 16, height = 8)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/british_columbia/gallery/election_2019_04_bc.png", mp, width = 15, height = 10.5)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/british_columbia/gallery/election_2019_04_bc_urban.png", mp, width = 17.5, height = 6)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/british_columbia/gallery/election_2019_04_bc_rural.png", mp, width = 12.5, height = 5)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/alberta/gallery/election_2019_04_ab.png", mp, width = 17.5, height = 7.5)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/alberta/gallery/election_2019_04_ab_calgary.png", mp, width = 12.5, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/alberta/gallery/election_2019_04_ab_edmonton.png", mp, width = 12.5, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/alberta/gallery/election_2019_04_ab_rural.png", mp, width = 12.5, height = 5)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/saskatchewan/gallery/election_2019_ByDistrict_sk.png", mp, width = 10, height = 6)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/saskatchewan/gallery/election_2019_04_sk_rural.png", mp, width = 10, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/saskatchewan/gallery/election_2019_04_sk_urban.png", mp, width = 8, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/manitoba/gallery/election_2019_04_mb.png", mp, width = 10, height = 6)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/manitoba/gallery/election_2019_05_mb_rural.png", mp, width = 8, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/manitoba/gallery/election_2019_06_mb_winnipeg.png", mp, width = 10, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/ontario/gallery/election_2019_04_on.png", mp, width = 27.5, height = 16.5)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/quebec/gallery/election_2019_04_qc.png", mp, width = 25, height = 12)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/new_brunswick/gallery/election_2019_ByDistrict_nb.png", mp, width = 12.5, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/nova_scotia/gallery/election_2019_04_ns.png", mp, width = 15, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/prince_edward_island/gallery/election_2019_04_pe.png", mp, width = 10, height = 3)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/newfoundland_Labrador/gallery/election_2019_04_nl.png", mp, width = 10, height = 4)
```
...
```{r echo = F}
ggsave("../../dblogr_graphs/2019_canadian_election_results/canada/gallery/election_2019_00_Other.png", mp, width = 6, height = 4)
```
