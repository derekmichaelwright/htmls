...
![Figure 1: Number of forest fires per year.](amazon_fires_01.png)
...
![Figure 2: Number of forest fires per year, since 2013.](amazon_fires_02.png)

Even when looking at this subset of the data, it doesn't appear to be some kind of crisis. But 2019 isn't done yet so lets look at the data by month:
...
![Figure 3: Number of forest fires per month, 2013-2019.](amazon_fires_03.png)
...
![Figure 4: Number of forest fires per month, 1998-2019.](amazon_fires_04.png)
...
![Figure 5: Number of forest fires per month, 2012, 2013 & 2019.](amazon_fires_05.png)
...
![Figure 6: Number of forest fires per month, 2010 & 2019.](amazon_fires_06.png)
...
![Figure 7: Number of forest fires per month for selected years.](amazon_fires_07.png)
...
![Figure 8: Cumulative number of forest fires by month, 1998-2019.](amazon_fires_08.png)
