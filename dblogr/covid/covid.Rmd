---
title: "COVID-19"
subtitle: "A quick death rate from COVID-19 in Canada"
date: "2020-10-07"
...
mp <- ggplot(xx, aes(x = date, y = numtoday, color = prname)) + 
  ...
  labs(title = "COVID-19 Cases in Canada", y = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: Government of Canada")
ggsave("Canada_COVID_01.png", mp, width = 6, height = 4)
```

```{r echo = F}
ggsave("../../../myblog/content/graphs_dblogr/covid/gallery/gallery/Canada_COVID_01.png", mp, width = 6, height = 4)
```
...
ggsave("Canada_COVID_02.png", mp, width = 6, height = 4)
```

```{r echo = F}
ggsave("../../../myblog/content/graphs_dblogr/covid/gallery/gallery/Canada_COVID_02.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = date, y = numdeathstoday, color = prname)) + 
  ...
  facet_wrap(prname ~ ., ncol = 5) +
  theme_agData(legend.position = "none") +
  labs(caption = "\xa9 www.dblogr.com/  |  Data: Government of Canada")
ggsave("Canada_COVID_03.png", mp, width = 6, height = 4)
```

```{r echo = F}
ggsave("../../../myblog/content/graphs_dblogr/covid/gallery/gallery/Canada_COVID_03.png", mp, width = 6, height = 4)
```
...
# Plot
mp <- mp + facet_wrap(prname ~ ., ncol = 5, scales = "free_y") 
ggsave("Canada_COVID_04.png", mp, width = 6, height = 4)
```

```{r echo = F}
ggsave("../../../myblog/content/graphs_dblogr/covid/gallery/gallery/Canada_COVID_04.png", mp, width = 6, height = 4)
```
...
gg_COVID <- function(x, area) {
  ...
  ggplot(x, aes(x = date, y = Value, color = Trait)) + 
    ...
    theme_agData() +
    labs(title = "COVID-19", y = NULL, x = NULL,
         caption = "\xa9 www.dblogr.com/  |  Data: Government of Canada")
}
# Plot
