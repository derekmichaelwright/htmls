...
links:
  - icon: chart-line
    icon_pack: fas
    name: All Graphs
    url: dblogr_graphs/hex_stickers
  - icon: file-code
    icon_pack: far
    name: HTML
  ...
  - icon: file-pdf
    icon_pack: far
    name: PDF (Save/Print)
    url: dblogr_pdfs/hex_stickers.pdf
---
...
```{r echo = F, eval = F}
file.copy(from = "hex_dblogr.png", to = "C:/gitfolder/myblog/content/dblogr_graphs/hex_stickers/gallery/gallery/hex_dblogr.png", overwrite = T)
file.copy(from = "hex_agData.png", to = "C:/gitfolder/myblog/content/dblogr_graphs/hex_stickers/gallery/gallery/hex_agData.png", overwrite = T)
file.copy(from = "hex_mapleleaf_green.png", to = "C:/gitfolder/myblog/content/dblogr_graphs/hex_stickers/gallery/gallery/hex_mapleleaf_green.png", overwrite = T)
file.copy(from = "hex_mapleleaf_red.png", to = "C:/gitfolder/myblog/content/dblogr_graphs/hex_stickers/gallery/gallery/hex_mapleleaf_red.png", overwrite = T)
#
