...
author: "Derek Michael Wright <wrightmderek@gmail.com> [www.dblogr.com/](https://dblogr.netlify.com/) [Image Gallery](https://dblogr.netlify.app/graphs_dblogr/misleading_graphs/)"
date: "2020-09-01"
categories: [ "dblogr" ]
...
Using statistics to mislead can be a trivial thing. We will go through some examples of how to one can mislead people with improper graphs. Examples include:
...
mp <- ggplot(xx, aes(x = Oranic_Area, y = Rate)) + 
  ...
  theme_agData() +
  labs(title = "Correlation between organic agriculture and autism rates",
...
mp1 <- ggplot(yy, aes(x = Year, y = Value, color = CherryPicked)) +
  ...
  theme_agData(legend.position = "none") +
  labs(subtitle = "A) Cherry picked", y = "tonnes / hectare", x = NULL)
